        ...
        <footer className="bg-gray-100 text-gray-700">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    <div>
                        <h3 className="text-xl font-bold text-pitaya-pink mb-4">Pitaya Nails</h3>
                        <p className="text-gray-600">Arte en uñas con actitud. <br />Cancún, México.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex justify-center md:justify-start space-x-4">
                            <a href={INSTAGRAM_LINK} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pitaya-pink transition">
                                <InstagramIcon className="w-6 h-6" />
                            </a>
                            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pitaya-pink transition">
                                <WhatsAppIcon className="w-6 h-6" />
                            </a>
                        </div>
                         <p className="mt-4 text-sm text-gray-600">Lun - Sáb: 10:00 - 20:00</p>
                    </div>
                </div>
