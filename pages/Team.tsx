        ...
        <div className="bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                <div className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold text-pitaya-dark font-serif">Nuestro Equipo</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {TEAM.map(member => (
                        <div key={member.id} className="bg-white p-6 rounded-lg shadow-lg text-center transform hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-pitaya-dark font-serif">{member.name}</h3>
