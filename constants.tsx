...
export const SERVICES: Service[] = [
  ...
  { id: 'nail-art', name: 'Nail Art Avanzado', description: 'Diseños a mano alzada, pedrería y efectos especiales (precio por uña).', duration: 15, price: 100, category: 'Nail Art', imageUrl: 'https://picsum.photos/seed/nailart/400/300', isCustomizable: true, customizationPrompt: 'Número de uñas', pricePerUnit: true, durationPerUnit: true },
  ...
  { id: 'mani-rusa', name: 'Manicura Rusa en Seco', description: 'Técnica precisa de limpieza profunda de cutícula con torno para un acabado impecable y duradero.', duration: 75, price: 500, category: 'Manicura', imageUrl: 'https://picsum.photos/seed/manirussa/400/300' },
  { id: 'retiro-gel', name: 'Retiro de Esmalte en Gel', description: 'Eliminación segura y profesional de esmalte en gel, protegiendo la uña natural.', duration: 30, price: 150, category: 'Manicura', imageUrl: 'https://picsum.photos/seed/gelremoval/400/300' },
  { id: 'reparacion', name: 'Reparación de Uña', description: 'Arreglo de uña rota o agrietada con acrílico o gel constructor (precio por uña).', duration: 15, price: 80, category: 'Uñas Esculturales', imageUrl: 'https://picsum.photos/seed/nailrepair/400/300', pricePerUnit: true, durationPerUnit: true, isCustomizable: true, customizationPrompt: 'Número de uñas' },
  { id: 'pedi-classic', name: 'Pedicura Clásica', description: 'Cuidado esencial para tus pies, incluye limado, cutículas, exfoliación suave y esmaltado tradicional.', duration: 50, price: 400, category: 'Pedicura', imageUrl: 'https://picsum.photos/seed/pediclassic/400/300' },
  { id: 'relleno-acrilico', name: 'Relleno de Acrílico', description: 'Mantenimiento para uñas acrílicas (hasta 3 semanas), rellenando el crecimiento.', duration: 90, price: 650, category: 'Uñas Esculturales', imageUrl: 'https://picsum.photos/seed/acrifill/400/300' },
  { id: 'polygel', name: 'Uñas de Polygel', description: 'Ligeras, flexibles y resistentes. La innovación entre el acrílico y el gel.', duration: 120, price: 900, category: 'Uñas Esculturales', imageUrl: 'https://picsum.photos/seed/polygel/400/300' },
  { id: 'soft-gel', name: 'Extensión con Soft Gel', description: 'Extensiones de uña completas pre-moldeadas con gel. Ligeras y de aspecto natural.', duration: 90, price: 750, category: 'Uñas Esculturales', imageUrl: 'https://picsum.photos/seed/softgel/400/300' },
  { id: 'nail-art-french', name: 'Diseño Francés', description: 'El clásico y elegante diseño francés en punta, personalizable en colores.', duration: 20, price: 150, category: 'Nail Art', imageUrl: 'https://picsum.photos/seed/french/400/300' },
  { id: 'nail-art-chrome', name: 'Efecto Espejo / Cromo', description: 'Acabado metálico y reflectante que captura todas las miradas (precio por set completo).', duration: 25, price: 200, category: 'Nail Art', imageUrl: 'https://picsum.photos/seed/chrome/400/300' },
  { id: 'parafina', name: 'Tratamiento de Parafina', description: 'Baño de parafina caliente para una hidratación profunda de manos o pies.', duration: 20, price: 250, category: 'Spa', imageUrl: 'https://picsum.photos/seed/paraffin/400/300' },
  { id: 'spa-pies', name: 'Spa de Pies', description: 'Un tratamiento de lujo para tus pies con sales minerales, exfoliación profunda y mascarilla.', duration: 45, price: 480, category: 'Spa', imageUrl: 'https://picsum.photos/seed/footspa/400/300' }
];
